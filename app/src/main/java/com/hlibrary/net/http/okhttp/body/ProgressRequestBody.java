package com.hlibrary.net.http.okhttp.body;
...
public class ProgressRequestBody extends RequestBody {
     ...
     * @param fileUploadCallback 回调接口
     */
    public ProgressRequestBody(RequestBody requestBody, IFileUploadCallback fileUploadCallback) {
